...
public record GetApprovalsPageQuery(ApprovalsFilterViewModel Filter, Guid? CallerBuildingId, bool CallerIsSuperAdmin) : IRequest<ApprovalsPageViewModel>;

public class GetApprovalsPageQueryHandler(UserManager<ApplicationUser> userManager, IUserManagementRepository repository)
    : IRequestHandler<GetApprovalsPageQuery, ApprovalsPageViewModel>
{
    public async Task<ApprovalsPageViewModel> Handle(GetApprovalsPageQuery request, CancellationToken cancellationToken = default)
    {
