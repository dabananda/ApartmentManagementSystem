...
namespace ApartmentManagementSystem.Application.Features.Tenancy.DTOs
{
    public class TenantBillsPage
    {
        ...
        public List<ApartmentManagementSystem.Application.Features.TenantPortal.DTOs.TenantBillRow> Bills { get; set; } = new();
